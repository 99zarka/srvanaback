...
class ReviewTests(APITestCase):
    def setUp(self):
        ...
        self.detail_url_other_client_other_tech = reverse('review-detail', args=[self.review_other_client_other_tech.id])
    ...
    def test_client_retrieve_other_client_review_forbidden(self):
        client = self.get_auth_client(self.client_user)
        response = client.get(self.detail_url_other_client_other_tech)
    ...
    def test_client_update_other_client_review_forbidden(self):
        ...
        response = client.patch(self.detail_url_other_client_other_tech, updated_data, format='json')
    ...
    def test_client_delete_other_client_review_forbidden(self):
        client = self.get_auth_client(self.client_user)
        response = client.delete(self.detail_url_other_client_other_tech)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
