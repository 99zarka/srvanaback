...
urlpatterns = [
    ...
    path('<int:order_id>/start-job/',
         views.OrderViewSet.as_view({'post': 'start_job'}),
         name='order-start-job'),
    ...
    path('<int:order_id>/dispute-order/',
         views.OrderViewSet.as_view({'get': 'dispute_order'}),
         name='order-dispute-order'),
    ...
    # These paths are intentionally before the general router include to ensure they take precedence
